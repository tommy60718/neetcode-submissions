class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        for r in range(len(s)):
            right_key = s[r]
            # We need to use defaultdict, and remember to specify defaultdict(int)
            # bacause +=1 call dict even there's no corresponding key
            freq_dict[right_key]+=1 
            # cumulative value = size - highest_value
